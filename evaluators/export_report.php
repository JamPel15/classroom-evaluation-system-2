...
if($export_type == 'pdf') {
    ...
    exportEvaluationForm($evaluations, $academic_year, $semester);
}

function exportEvaluationForm($evaluations, $academic_year, $semester) {
    ...
    <div class="max-w-4xl mx-auto p-6 bg-white">
        ...
        <div class="mb-6">
            ...
            <table class="w-full form-table text-xs">
                <tr>
                    ...
                    <td class="w-32 border-b border-gray-400">' . htmlspecialchars($academic_year) . '</td>
                    <td class="w-20 font-medium">Semester:</td>
                    <td class="w-12 text-center">( ) 1st</td>
                    <td class="w-12 text-center">( ) 2nd</td>
                </tr>
                <tr>
                    <td class="font-medium">Department:</td>
                    <td class="border-b border-gray-400"></td>
                    <td class="font-medium">Subject/Time of Observation:</td>
                    <td colspan="3" class="border-b border-gray-400"></td>
                </tr>
                <tr>
                    <td colspan="2"></td>
                ...
                <tr>
                    <td colspan="7" class="font-medium">Type of Classroom Observation: Please check the appropriate box: ( ) Formal ( ) Informal</td>
                </tr>
            </table>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4 mb-6">
            <div>
                ...
                <div class="border border-gray-800 h-32"></div>
            </div>
            <div>
        ...
        <div class="mb-6">
            ...
            <div class="border border-gray-800 h-24"></div>
        </div>
